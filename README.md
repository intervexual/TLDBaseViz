...
* [Rabbitskin Mittens by Hilmy Abiyyu Asad](https://thenounproject.com/icon/mitten-8171783/)
...
* [Wolfskin Hat by Lars Meiertoberens](https://thenounproject.com/icon/werewolf-5257164/)
...
## TODOs
1. Make legends for the documentation
2. Have the legend in the base vis only show an item if >0
3. non-interloper clothes? Aviator hat, cougar wrap, ski jacket, bear jacket
4. stacks of items like arrows
5. add bow, simple arrows, fire arrows
